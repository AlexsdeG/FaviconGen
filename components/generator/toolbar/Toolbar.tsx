...
import { Type, Box, Circle, Star, Square, Upload, Smile, ChevronDown, MousePointer2, Minus, Plus, Maximize, Undo2, Redo2, Triangle, Hexagon, Octagon, Download, Navigation, Sparkles, Magnet } from 'lucide-react';
...
const Toolbar: React.FC<ToolbarProps> = ({ onExport }) => {
  const { addLayer, canvasConfig, centerSelection, stageConfig, setStageConfig, selectedLayerId, undo, redo, history, historyIndex, snapping, setSnappingOptions } = useEditorStore();
